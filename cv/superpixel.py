...
def LSC(img,iterate:int=10,label:bool=False,number:bool=False,mask:bool=False,on_img:bool=True):
...
def generateLSC_onbatch(srcDir:str,distDir:str,color:int=1,resize_shape=None,iterate:int=10,mask:bool=False,on_img:bool=True):
    if mask:
